...
QPixmap getTransferPixmap(const CryptoNote::WalletTransfer& _transfer) {
  if (_transfer.type == CryptoNote::WalletTransferType::DONATION) {
    return QPixmap("C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/donation_confirmed.png");
  } else if (_transfer.amount < 0) {
    return QPixmap("C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/out_confirmed.png");
  }

  return QPixmap("C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/inp_confirmed.png");
}
