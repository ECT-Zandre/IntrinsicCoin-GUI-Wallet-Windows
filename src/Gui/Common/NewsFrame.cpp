...
const char NEWS_FRAME_STYLE_SHEEET_TEMPLATE[] =
  ...
  "WalletGui--NewsFrame #m_scrollFrame #m_scrollUpButton {"
    "image: url(""C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/scroll-news-up.png"");"
  "}"

  "WalletGui--NewsFrame #m_scrollFrame #m_scrollUpButton:hover {"
    "image: url(""C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/scroll-news-up-hover.png"");"
  "}"

  "WalletGui--NewsFrame #m_scrollFrame #m_scrollDownButton {"
    "image: url(""C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/scroll-news-down.png"");"
  "}"

  "WalletGui--NewsFrame #m_scrollFrame #m_scrollDownButton:hover {"
    "image: url(""C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/scroll-news-down-hover.png"");"
  "}"
;
