...
const char OVERVIEW_HEADER_STYLE_SHEET_TEMPLATE[] =
  ...
  "WalletGui--OverviewHeaderFrame #m_startMiningButton {"
    ...
    "color: #e7ffb3;" //#ffffff
    "image: url(""C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/start-mining.png"");"
    "image-position: left;"
    "padding-left: 7px;"
  "}"
  ...
  "WalletGui--OverviewHeaderFrame #m_startMiningButton:checked {"
    ...
    "background-color: %backgroundColorGray%;"
    "color: %fontColorGray%;"
    "image: url(""C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/stop-mining.png"");"
  "}"
...
OverviewHeaderFrame::OverviewHeaderFrame(QWidget* _parent) : QFrame(_parent), m_ui(new Ui::OverviewHeaderFrame),
  ...
  m_miningMapper(new QDataWidgetMapper(this)), m_syncMovie(new QMovie("C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/icons/light/wallet-sync.png", QByteArray(), this)),
