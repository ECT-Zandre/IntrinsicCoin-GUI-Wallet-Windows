...
const char COMMUNITY_FORUM_URL[] = "https://medium.com/@intrinsicblockchain/";
const char REPORT_ISSUE_URL[] = "http://intrinsicblockchain.co.in/";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Intrinsiccoin Wallet %1").arg(Settings::instance().getVersion()));
