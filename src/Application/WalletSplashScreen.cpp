...
WalletSplashScreen::WalletSplashScreen(QWidget* _parent) :
  QSplashScreen(_parent, QPixmap("C:/Users/ashwan_2/Desktop/ForkNote/IntrinsicCoin-GUI-Wallet/src/images/splash.png"), Qt::WindowStaysOnTopHint | Qt::X11BypassWindowManagerHint) {
  QFont font;
